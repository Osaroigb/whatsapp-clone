...
const CaptureAudio = ({ hide }) => {
  ...
  return (
    <div className="flex text-2xl w-full justify-end items-center">
      ...
      <div className="mx-4 px-4 py-2 text-white flex text-lg gap-3 justify-center items-center bg-search-input-container-background rounded-full drop-shadow-lg">
        
        {isRecording ? (
          <div className="text-blue-500 animate-pulse 2-60 text-center">
      ...
      <div>
        <MdSend 
          className="mr-4 text-panel-header-icon cursor-pointer"
          title="Send"

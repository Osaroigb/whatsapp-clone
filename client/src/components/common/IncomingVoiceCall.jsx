...
const IncomingVoiceCall = () => {
  ...
  return (
    <div className="h-24 w-80 fixed bottom-b mb-0 right-6 z-50 rounded-sm flex gap-5 items-center justify-start p-4 bg-conversation-panel-background text-white drop-shadow-2xl border-icon-green border-2 py-14">
      ...
      <div>
        ...
        <div className="flex gap-2 mt-2">
          ...
          <button className="p-1 bg-green-500 px-3 text-sm rounded-full" onClick={acceptCall}>Accept</button>
        </div>

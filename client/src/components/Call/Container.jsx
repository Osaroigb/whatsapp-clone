...
const Container = ({ data }) => {
  ...
  return (
    <div className="w-full border-conversation-border bg-conversation-panel-background border-l flex flex-col h-[100vh] overflow-hidden items-center justify-center text-white">
